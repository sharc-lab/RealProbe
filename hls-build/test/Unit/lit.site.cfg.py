## Autogenerated from /usr/scratch/jkim3998/hls-llvm-project-realprobe/hls-llvm-project/llvm/test/Unit/lit.site.cfg.py.in
## Do not edit!
...
lit_config.load_config(config, "/usr/scratch/jkim3998/hls-llvm-project-realprobe/hls-llvm-project/llvm/test/Unit/lit.cfg.py")
