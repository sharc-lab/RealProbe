...
#pragma HLS INTERFACE m_axi port = A depth=9 offset = slave bundle = a_port
#pragma HLS INTERFACE m_axi port = B depth=9 offset = slave bundle = b_port
#pragma HLS INTERFACE m_axi port = X depth=9 offset = slave bundle = c_port
#pragma HLS INTERFACE m_axi port = Y depth=9 offset = slave bundle = d_port
